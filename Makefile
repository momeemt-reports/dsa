...
$(TEST_BIN_DIR)/test_naive_out: $(TEST_DIR)/test_naive.c $(OBJ_DIR)/naive.o $(OBJ_DIR)/cmp.o $(OBJ_DIR)/kmp.o $(OBJ_DIR)/compnext.o
	$(CC) -g $(TEST_CFLAGS) $^ $(TEST_LIB) -o $@

$(TEST_BIN_DIR)/test_compnext_out: $(TEST_DIR)/test_compnext.c $(OBJ_DIR)/compnext.o $(OBJ_DIR)/cmp.o
	$(CC) $(TEST_CFLAGS) $^ $(TEST_LIB) -o $@

$(TEST_BIN_DIR)/test_kmp_out: $(TEST_DIR)/test_kmp.c $(OBJ_DIR)/kmp.o $(OBJ_DIR)/compnext.o $(OBJ_DIR)/cmp.o
	$(CC) $(TEST_CFLAGS) $^ $(TEST_LIB) -o $@
