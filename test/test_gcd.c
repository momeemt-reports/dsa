...
int main(void) {
  ...
  CU_pSuite gcd_recursive_suite =
      CU_add_suite("GCD Recursive Test", NULL, NULL);
  if (gcd_recursive_suite == NULL) {
    CU_cleanup_registry();
    return CU_get_error();
  }
  CU_add_test(gcd_recursive_suite, "GCD_Recursive_Test_1",
              gcd_recursive_test_1);
  // CU_add_test(gcd_recursive_suite, "GCD_Recursive_Test_2",
  // gcd_recursive_test_2); CU_add_test(gcd_recursive_suite,
  // "GCD_Recursive_Test_3", gcd_recursive_test_3);
  // CU_add_test(gcd_recursive_suite, "GCD_Recursive_Test_4",
  // gcd_recursive_test_4); CU_add_test(gcd_recursive_suite,
  // "GCD_Recursive_Test_5", gcd_recursive_test_5);
